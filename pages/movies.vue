...
const onClickHandler = (page: number) => {
  router.push({ path: "/movies", query: { page: page } });
};

const { data, error, execute } = await apiFetch("/movies", {
    params: {
      page: route.query?.page,
    },
  }, "movies" + pagination.value.pageNumber);
...
<template>
  <div class="movies">
    <DefaultList title="ფილმები" :contentData="moviesData" :is-signed="isUserSigned" />
